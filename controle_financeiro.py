...
PASTA_APP   = os.path.dirname(os.path.abspath(**file**))
...
1. **Pontos positivos** (2-3 itens com bullet •)
1. **Alertas** (2-3 itens com bullet ⚠)
1. **Recomendações para o próximo mês** (3 ações concretas numeradas)
1. **Tendência** (análise do histórico se houver dados)
1. **Mensagem motivadora** (1-2 linhas)
